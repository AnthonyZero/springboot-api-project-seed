...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl(properties.getProperty("spring.datasource.druid.first.url"));
        dsc.setDriverName(properties.getProperty("spring.datasource.driverClassName"));
        dsc.setUsername(properties.getProperty("spring.datasource.druid.first.username"));
        dsc.setPassword(properties.getProperty("spring.datasource.druid.first.password"));
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setModuleName(scanner("模块名")); //在哪个模块下
        pc.setParent("com.anthonyzero.seed.modules");
